...
git clone https://github.com/oreales/warden-multi-arch.git /opt/warden
...
Add the registry & user prefix of `ghcr.io/oreales/` to all the below packages for usage. All the below packages are available for both `linux/arm64` and `linux/amd64` architectures.
